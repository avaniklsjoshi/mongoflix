...
export default class CommentsDAO {
  ...
  */
  ...
  static async addComment(movieId, user, comment, date) {
    try {
      // TODO done Ticket: Create/Update Comments
  ...
  static async deleteComment(commentId, userEmail) {
    ...
    */
    ...
    try {
      // TODO done Ticket: Delete Comments
  ...
  static async mostActiveCommenters() {
    ...
    */
    try {
      // TODO done Ticket: User Report
      // Return the 20 users who have commented the most on MFlix.
      const groupByEmailId = {
        $group: {
          _id: "$email",
          count: {
            $sum: 1,
      ...
      const pipeline = [groupByEmailId, sortByComments, top20]
